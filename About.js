...
const links = [
    { name: 'Features 1', href: '#' },
    { name: 'Features 2', href: '#' },
    { name: 'Features 3', href: '#' },
    { name: 'Features 4', href: '#' },
  ]
  const stats = [
    { name: 'Seating Arrangment', value: '2200+' },
    { name: 'Books', value: '15K+' },
    { name: 'Opening hours', value: '15' },
    { name: 'Book Issue Period', value: '30 days' },
  ]
